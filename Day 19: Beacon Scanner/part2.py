...
def compute(s: str) -> int:
    ...
    max_dist = 0
    for scanner, other in combinations(scanners, 2):
        p1 = [scanner.axi[i].div for i in range(3)]
        p2 = [other.axi[i].div for i in range(3)]
        max_dist = max(max_dist, cityblock(p1, p2))
